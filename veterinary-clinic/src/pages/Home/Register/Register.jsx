  ...
  return (
    <>
        ...
        <div className='ctn-register'>
            ...
            <p className='register-description-title'>Completa un sencillo formulario, agrega a todas tus mascotas y adéntrate en un mundo de amor en nuestra comunidad ♥</p>
            <form>
                      ...
                      <div className='ctn-pet'>
                        <div className='section-form-pets'>
                          <div className='register-pet-section'>
                            <input className='input-pet' type='text' name='petName' value={pet.petName} placeholder='Nombre' onChange={inputPetsChange}></input>
                          </div>
                          <div className='register-pet-section'>
                            <input className='input-pet' type='number' name='age' value={pet.age} placeholder='Edad' onChange={inputPetsChange}></input>
                          </div>
                        </div>
                        <div className='section-form-pets'>
                          <div className='register-pet-section'>
                            <select value={pet.gender} name='gender' onChange={inputPetsChange}>
                          ...
                          <div className='register-pet-section'>
                            <select value={pet.petSpecies} name='petSpecies' onChange={inputPetsChange}>
